...
import { faAngleUp, faBars, faBell, faCalendar, faCircle, faClipboardList, faCogs, faComments, faDollarSign, faDonate, faEllipsisV, faEnvelope, faExclamationTriangle, faFileAlt, faList, faSearch, faSignOutAlt, faUser } from '@fortawesome/free-solid-svg-icons'
                                        ...
                                        <div
                                            ...
                                            <div className="dropdown no-arrow">
                                                <a className="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                                    ...
                                                    <i className="fas fa-sm fa-fw text-gray-400">
                                    ...
                                    <div className="card shadow mb-4">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mt-4 text-center small">
                                                <span className="mr-2">
                                                    <i className="fastext-primary">
                                                        <FontAwesomeIcon icon={faCircle} />
                                                    </i> Direct
                                                </span>
                                                <span className="mr-2">
                                                    <i className="fas text-success">
                                                        <FontAwesomeIcon icon={faCircle} />
                                                    </i> Social
                                                </span>
                                                <span className="mr-2">
                                                    <i className="fas text-info">
                                                        <FontAwesomeIcon icon={faCircle} />
                                                    </i> Referral
                                                </span>
                                            </div>
